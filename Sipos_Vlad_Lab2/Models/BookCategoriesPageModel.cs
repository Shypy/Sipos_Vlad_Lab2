...
namespace Sipos_Vlad_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Sipos_Vlad_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Sipos_Vlad_Lab2Context context,
